export const company = {
  name: 'Portafolio',
  slogan: '👨‍💻Proyectos desarrollados👨‍💻',
  comercialActivity: 'Desarrollo de Software'
}

export const author = 'Elliot Garamendi';
...
export const developedProjects = [
  ...
  },
  {
    ...
    mainTechnology: 'React',
    technologies: 'React, HTML, CSS, JavaScript, Bootstrap, Animate.css',
    about: 'Portafolio de Proyectos Desarrollados. Aplicación que lista los proyectos desarrollados del profesional brindando la información más relevante. Se puede ingresar al Demo y al código fuente.',
    image: 'https://i.imgur.com/mLPINFH.png',
  ...
  },
  {
    ...
    mainTechnology: 'React',
    technologies: 'React, HTML, CSS, JavaScript, Bootstrap, SweetAler2, Animate.css',
    about: 'Veterinaria Patita Feliz. Aplicación que cuenta con un formulario para el registro de citas, además, se puede confirmar las citas como también eliminarlas.',
